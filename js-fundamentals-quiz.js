...
//ANSWER//
//Because of the properties with closures
/////////
...
const foodData = userData.map((user) => {
  return {
    id: user.id,
...
const pizzaFavs = userData.reduce((accumulator, user) => {
...
switch (juice) {
  case 'orange':
    ...
    break;
  case 'apple':
    console.log('This is apple juice.');
    break;
  case 'grape':
    console.log('This is grape juice.');
    break;
  default:
    console.log('This is weird juice.');
}
...
let favFoods = user2.favoriteThings.food;
...
const data5 = ['peter', '34', 'apple', 'oranges', 'pizza', 'tacos'];
